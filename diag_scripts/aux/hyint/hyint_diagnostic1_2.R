...
#-------------E. Arnone (June 2017)------------------#
######################################################
hyint.diagnostic<-function(exp,year1,year2,season,rgrid,rlonlatdata,infile,work_dir,force_calc,norm_year_cutoff,diag_script_cfg) {
...
# when the number of arguments is ok run the function()
        ...
        hyint.diagnostic(exp,year1,year2,season,rgrid,rlonlatdata,infile,work_dir,force_calc,norm_year_cutoff,diag_script_cfg)
    }
}
