...
if (plot_type > 2) { field_names=field_names[1:3] } # keep only int_norm, dsl_norm and hyint
...
name_args=c("exp","year1","year2","dataset_ref","year1_ref","year2_ref","season","plot_dir","work_dir","ref_dir","diag_script_cfg","PROGDIR")
