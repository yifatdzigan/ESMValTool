...
# #############################################################################
# Description
# This script writes only references for the RainFARM diagnostics
#
# ############################################################################
"""
...
def main(project_info):
    ...
    if "rainfarm" in config_file:
       diag_refs=["D_donofrio14jh","D_rebora06jhm"]
       diag_script="rainfarm.r"
    elif "hyint" in config_file:
