...
add_zeroline=F         # T to plot a dashed line at y=0 
...
selregions=c(1:5) # Select one or more index values to define regions to be used. Default c(1) == global. 
...
levels_m[11,]=c(0,12,-5,5)
levels_m[12,]=c(0,20,-5,5)
levels_m[13,]=c(0,20,-5,5)
levels_m[14,]=c(0,200,-5,5)
levels_m[15,]=c(0,12,-5,5)
levels_m[16,]=c(0,80,-5,5)
levels_m[17,]=c(4,16,-4,4)
levels_m[18,]=c(0,200,-10,10)
levels_m[19,]=c(0,300,-10,10)
levels_m[20,]=c(10,150,-10,10)
levels_m[21,]=c(0,1500,-100,100)
levels_m[22,]=c(0,60,-10,10)
levels_m[23,]=c(0,200,-10,10)
levels_m[24,]=c(0,20,-2,2)
levels_m[25,]=c(0,400,-20,20)
levels_m[26,]=c(0,100,-10,10)
levels_m[27,]=c(0,80,-10,10)
levels_m[28,]=c(0,200,-10,10)
levels_m[29,]=c(0,15,-5,5)
levels_m[30,]=c(0,150,-20,20)
levels_m[31,]=c(0,25,-5,5)
levels_m[32,]=c(0,20,-5,5)
levels_m[33,]=c(-40,10,-5,5)
levels_m[34,]=c(5,25,-5,5)
levels_m[35,]=c(0,50,-5,5)
levels_m[36,]=c(0,20,-2,2)
levels_m[37,]=c(5,20,-4,4)
levels_m[38,]=c(-40,10,-5,5)
levels_m[39,]=c(20,50,-2,2)
levels_m[40,]=c(0,20,-2,2)
...
tlevels_m[27,]=c(0,30)*0.01
tlevels_m[28,]=c(0,50)*0.01
tlevels_m[29,]=c(0,15)*0.01
tlevels_m[30,]=c(20,140)*0.01
tlevels_m[31,]=c(-20,0)*0.01
tlevels_m[32,]=c(0,20)*0.01
tlevels_m[33,]=c(0,8)*0.01
tlevels_m[34,]=c(4,8)*0.01
tlevels_m[35,]=c(0,200)*0.01
tlevels_m[36,]=c(-15,0)*0.01
tlevels_m[37,]=c(0,15)*0.01
