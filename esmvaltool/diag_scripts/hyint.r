...
source('esmvaltool/diag_scripts/aux/hyint/hyint_preproc.R')
source('esmvaltool/diag_scripts/aux/hyint/hyint_diagnostic.R')
source('esmvaltool/diag_scripts/aux/hyint/hyint_etccdi_preproc.R')
